...
const menuArray = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "104A", subUrl: "/FloorPlan/59B" },
      { subTitle: "123A", subUrl: "/FloorPlan/84A" },
      { subTitle: "173A", subUrl: "/FloorPlan/84B" },
      { subTitle: "201A", subUrl: "/FloorPlan/114A" },
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu((v) => !v)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#af6a55" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#af6a55" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1555-2393">
            <IoCall className={styles.icon} size={25} color="#af6a55" />
          </a>
        </div>
        {isInterestPopupOpen && (
          <InterestPopup
