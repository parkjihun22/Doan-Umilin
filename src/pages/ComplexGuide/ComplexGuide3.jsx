...
<Helmet>
  <title>도안 우미린 트리쉐이드 임대 - 커뮤니티</title>
  <meta
    name="description"
    content="도안 우미린 트리쉐이드 임대의 커뮤니티 시설을 소개합니다. 피트니스센터, 실내 골프연습장, 작은도서관(북카페), 주민 라운지 등 입주민의 생활 품격을 높이는 다양한 편의시설을 확인하세요."
  />
  ...
  <meta property="og:title" content="도안 우미린 트리쉐이드 임대 - 커뮤니티" />
  <meta
    property="og:description"
    content="피트니스·실내 골프·작은도서관·라운지 등 다양한 커뮤니티 시설로 일상의 가치를 높이는 도안 우미린 트리쉐이드 임대."
  />
...
<h1 className={styles.screenReaderOnly}>
  도안 우미린 트리쉐이드 임대 - 커뮤니티
</h1>
<p className={styles.screenReaderOnly}>
  도안 우미린 트리쉐이드 임대의 커뮤니티 페이지에서는 단지 내 다양한 시설을 소개합니다.
  피트니스센터, 실내 골프연습장, 작은도서관(북카페), 주민 라운지 등
  다채로운 커뮤니티 공간을 통해 입주민의 삶의 질을 높이고
  쾌적한 공동체 생활을 지원합니다.
</p>

<div className={styles.textBox}>
  <div>일상을 더 풍요롭게 만드는 커뮤니티 라이프</div>
  <div>도안 우미린 트리쉐이드 임대의 커뮤니티를 만나보세요.</div>
</div>
      ...
      <img
				...
				src={page1}
				alt="도안우미린트리쉐이드임대커뮤니티 안내 -image1"
