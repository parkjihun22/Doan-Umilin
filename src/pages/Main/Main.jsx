...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `대규모 브랜드 단지`,
    text2: `총 1,754세대 우미린 대단지<br/>
            지하 4층~지상 38층 · 11개동 · 공원형 단지`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통망 & 트램 호재`,
    text2: `도안대로·유성대로로 대전 전역 접근성<br/>
            도시철도 2호선 트램(예정)으로 미래 가치`,
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTitleBox}>
              <div className={styles.mainImageText}>도안신도시가 기다린 프리미엄 라이프</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text2}>
                  도안 우미린 트리쉐이드 임대 POINT
                </div>
                <div className={styles.text3}>
                  - 도안대로·유성대로 등 주요 도로망과 도시철도 2호선 트램(예정)으로 대전 전역 접근성 우수<br />
                  - 대형마트·상업시설·행정시설·의료 인프라가 가까운 편리한 생활 환경<br />
                  - 근린공원·수변공간 등 쾌적한 자연환경을 누리는 도안신도시 주거 입지<br />
                  - 지상 차 없는 공원형 단지와 커뮤니티 특화(피트니스·골프·라운지·북카페 등)
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="도안우미린트리쉐이드임대아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="도안우미린트리쉐이드임대브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>도안우미린트리쉐이드임대</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mblnngpg"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="도안우미린트리쉐이드임대오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="도안우미린트리쉐이드임대mobilemain-image1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              도안신도시의 새로운 시작, 기대되는 미래가치<br/>
              브랜드 신뢰 우미린
              <br />
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text3}>
              - 도안대로·유성대로 등 도시철도 2호선 (예정)으로 대전 전역 접근성 우수<br />
              - 대형마트·상업시설·행정시설·의료 인프라가 가까운 편리한 생활 환경<br />
              - 근린공원·수변공간 등 쾌적한 자연환경을 누리는 도안신도시 주거 입지<br />
              - 지상 차 없는 공원형 단지와 커뮤니티 특화(피트니스·골프·라운지·북카페 등)
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 도안우미린트리쉐이드임대에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="도안우미린트리쉐이드임대모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="도안우미린트리쉐이드임대브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="도안우미린트리쉐이드임대오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
