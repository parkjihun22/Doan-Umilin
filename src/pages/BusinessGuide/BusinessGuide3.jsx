...
<h1 className={styles.screenReaderOnly}>도안 우미린 트리쉐이드 임대 - 계약서류안내</h1>
<p className={styles.screenReaderOnly}>
  본 페이지는 분양(청약) 당첨 후 계약 체결을 위해 필요한 서류를 안내합니다.
  제출 서류 목록과 준비 방법, 제출 기한 및 유의사항을 확인하여
  계약 절차를 정확하고 원활하게 진행하시기 바랍니다.
</p>

<div className={styles.textBox}>
  <div>안정적인 계약을 위한 준비의 시작</div>
  <div>도안 우미린 트리쉐이드 임대, 계약서류를 미리 확인하세요.</div>
</div>



			{/* 이미지에 isImageVisible 상태 적용 */}
			{/* <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="도안우미린트리쉐이드임대계약서류안내-image1" /> */}
