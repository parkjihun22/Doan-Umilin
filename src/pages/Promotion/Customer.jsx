...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/mblnngpg", {
        method: "POST",
...
<Helmet>
  ...
  <title>도안 우미린 트리쉐이드 임대 - 관심고객등록</title>
  <meta
    name="description"
    content="도안 우미린 트리쉐이드 임대 관심고객 등록 시 모델하우스 오픈 안내, 방문예약, 청약 일정, 현장 위치 등 주요 정보를 가장 먼저 받아보실 수 있습니다."
  />
  ...
  <meta property="og:title" content="도안 우미린 트리쉐이드 임대 - 관심고객등록" />
  <meta
    property="og:description"
    content="관심고객 등록으로 모델하우스 방문예약, 청약 일정, 현장 위치 등 주요 안내를 우선 받아보세요."
  />
  ...
  <meta name="twitter:title" content="도안 우미린 트리쉐이드 임대 - 관심고객등록" />
  <meta
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "WebPage",
      "name": "도안 우미린 트리쉐이드 임대 - 관심고객등록",
      "url": "https://www.apay.co.kr/Promotion/Customer",
      "description":
        "도안 우미린 트리쉐이드 임대 관심고객 등록을 통해 모델하우스 오픈 안내, 방문예약, 청약 일정, 현장 위치 등 주요 정보를 우선 제공해 드립니다.",
      "primaryImageOfPage": {
        "@type": "ImageObject",
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>도안우미린트리쉐이드임대</h2>
